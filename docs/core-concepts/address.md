...
Represents a Zip address. Addresses are the most popular way to make Zip transactions. See [the Zip documentation](https://zip-docs.github.io/en/glossary/address) for technical background information.
...
The errors are listed in the generated file in the [errors folder](https://github.com/zipeva/bitcore-zip/tree/master/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/zipeva/bitcore-zip/tree/master/lib/errors/spec.js).
