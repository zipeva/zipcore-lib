...
```sh
git remote add zipeva git@github.com:zipeva/zipcore-lib.git
git pull --rebase zipeva master
```
...
Finally go to [github.com/zipeva/zipcore-lib](https://github.com/zipeva/zipcore-lib) in your web browser and issue a new pull request.
...
[github.com/zipeva/zipcore-lib/issues](https://github.com/zipeva/zipcore-lib/issues).
