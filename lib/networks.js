...
addNetwork({
  ...
  xpubkey256bit: 0x0eecefc5,    // 'dpmp' (zippay mainnet public)
  xprivkey256bit: 0x0eecf02e,   // 'dpms' (zippay mainnet secret)
  networkMagic: 0x3a097d06,
  port: 28080,
  dnsSeeds: [
    'dnsseed.6zip.online',
  ],
...
addNetwork({
  ...
  xpubkey256bit:    0x0eed270b,   // 'dptp' (zippay testnet public) 
  xprivkey256bit:   0x0eed2774// 'dpts' (zippay testnet secret)
});
